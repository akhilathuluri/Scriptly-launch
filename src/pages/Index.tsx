...
const homeSchema = [
  ...
  },
  {
    ...
    name: "Spark",
    url: "https://spark-app.in/",
    logo: "https://spark-app.in/favicon.ico",
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Download Spark",
        url: "https://spark-app.in/download",
      },
      {
        "@type": "SiteNavigationElement",
        position: 2,
        name: "Spark FAQs",
        url: "https://spark-app.in/faqs",
      },
      {
        "@type": "SiteNavigationElement",
        position: 3,
        name: "Issues and Feedback",
        url: "https://spark-app.in/issues",
      },
      {
        "@type": "SiteNavigationElement",
        position: 4,
        name: "Privacy Policy",
        url: "https://spark-app.in/privacy-policy",
      },
    ],
  },
];
