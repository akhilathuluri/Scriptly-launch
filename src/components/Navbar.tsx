...
const mobileLinkVariants: Variants = {
  ...
  visible: { opacity: 1, y: 0, transition: { duration: 0.28, ease: EASE_STANDARD } },
  exit: { opacity: 0, y: 10, transition: { duration: 0.2, ease: EASE_STANDARD } },
};
      ...
      {mobileMenuOpen && (
        ...
        >
          <div className="container mx-auto px-6 pt-24 pb-10 h-full">
            <motion.div variants={mobileLinkVariants} className="absolute top-4 right-4">
              <Button
                variant="outline"
                size="icon"
                className="h-10 w-10"
            ...
            <div className="h-full flex flex-col justify-center">
              ...
              <motion.p variants={mobileLinkVariants} className="mt-8 text-sm text-muted-foreground">
