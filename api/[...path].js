...
function buildTargetUrl(req, baseUrl) {
  ...
  const target = new URL(`/api/${pathSegments.join("/")}`, baseUrl);

  // Preserve query params except the catch-all path token.
...
export default async function handler(req, res) {
  ...
  const targetUrl = buildTargetUrl(req, convexSiteUrl);
